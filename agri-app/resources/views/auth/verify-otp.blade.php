...
<head>
    ...
    <title>Verify OTP - AgriCulture Blog</title>
                    ...
                    <div class="card shadow-lg border-0 rounded-4">
                        ...
                        <div class="card-body p-4">
                            <form method="POST" action="{{ route('otp.verify') }}">
                                ...
                                <div class="mb-3">
                                    <label for="otp" class="form-label"><b>Enter 6-digit OTP</b></label>
                                    <input type="text" class="form-control" id="otp" name="otp"
                                        placeholder="Enter the OTP" maxlength="6" required>
                                </div>
                            ...
                            <p class="text-center mt-3">
                                Didn't get the code? <a href="{{ route('forgot.password') }}"
