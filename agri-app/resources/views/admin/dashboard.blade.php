                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapsePages" aria-labelledby="headingTwo"
                            data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="{{ route('admin.blogs') }}"><i class="fas fa-edit me-2"></i>
                                    Manage
                                    Blogs</a>
                                <a class="nav-link" href="{{ route('admin.comments') }}"><i
                                        class="fas fa-comments me-2"></i> Manage
                                    Comments</a>
                                <a class="nav-link" href="{{ route('admin.likes') }}"><i
                                        class="fas fa-thumbs-up me-2"></i> Manage
                                    Likes</a>
                            </nav>
                        </div>
                    ...
                    <div class="row">
                            ...
                            <div class="card text-white mb-4"
                                ...
                                <div class="card-body d-flex align-items-center justify-content-between">
                                    <div>
                                        ...
                                        <h3>{{$users->count('id')}}</h3> <!-- Replace with dynamic value -->
                                    </div>
                            ...
                            <div class="card text-white mb-4"
                                ...
                                <div class="card-body d-flex align-items-center justify-content-between">
                                    <div>
                                        ...
                                        <h3>{{$blogsCount}}</h3> <!-- Replace with dynamic value -->
                                    </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card text-white mb-4"
                                ...
                                <div class="card-body d-flex align-items-center justify-content-between">
                                    <div>
                                        <h5 class="mb-1">Total Likes</h5>
                                        <h3>{{$likesCount}}</h3> <!-- Replace with dynamic value -->
                                    </div>
                            ...
                            <div class="card text-white mb-4"
                                ...
                                <div class="card-body d-flex align-items-center justify-content-between">
                                    <div>
                                        ...
                                        <h3>{{$commentsCount}}</h3> <!-- Replace with dynamic value -->
                                    </div>
                            ...
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    @forelse($users as $index => $user)
                                        <tr>
                                            <td>{{ $index + 1 }}</td> {{-- Counter starting from 1 --}}
