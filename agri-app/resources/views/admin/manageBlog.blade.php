                                ...
                                <tbody>
                                    @forelse($blogs as $index => $blog)
                                        <tr>
                                            ...
                                            <!-- Updated to use relationship -->
                                            <td>{{ $blog->category->name ?? 'N/A' }}</td>
                                            <!-- Updated to use relationship -->
                                            <td>{{ $blog->title ?? 'N/A' }}</td>
                                            <td>{{ Str::limit($blog->description, 50) ?? 'N/A' }}</td>
                                            <!-- Added limit to description -->
                                            <td>
                                                <img src="{{ asset('uploads/' . $blog->image) }}" alt="blog_img"
                                                    width="80px">
                                            </td>
                                            <td>{{ $blog->post_date ?? 'N/A' }}</td>
                                            <td>
